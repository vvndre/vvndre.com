          ...
          <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-4 z-10">
            ...
            >
              <Image
                ...
                width={800}
                height={460}
                className="aspect-[4/2.3] w-full "
              />

              <div className="p-5 text-center">
                <strong className="font-oswald text-xl">ARCHIVE.pdf</strong>
                <p className="mt-3 text-sm leading-relaxed text-white/80">
                  Archive Fashion Scans, Articles & Content for the World.
                </p>
                <div className="flex mt-4 justify-center justify-items-center gap-4">
                  <svg
            ...
            >
              ...
              <div className="p-5 text-center">
                <strong className="font-oswald text-xl">ICP DAS USA</strong>
                <p className="mt-3 text-sm leading-relaxed text-white/80">
                  Industrial Automation Products, Services & Support.
                </p>
                <div className="flex mt-4 justify-center justify-items-center gap-4">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
            ...
            >
              ...
              <div className="p-5 text-center">
                <strong className="font-oswald text-xl">Gamejot</strong>
                <p className="mt-4 text-sm leading-relaxed text-white/80">
                  The Ultimate Game Tracker Web App.
                </p>
                <div className="flex mt-4 justify-center justify-items-center gap-4">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
            ...
            >
              ...
              <div className="p-5 text-center">
                <strong className="font-oswald text-xl">
                  World Chamber TX
                </strong>
                <p className="mt-3 text-sm leading-relaxed text-white/80">
                  Nonprofit connecting chamber leaders worldwide.
                </p>
                <div className="flex mt-4 justify-center justify-items-center gap-4">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                  ...
                  <svg fill="#ffff" class="w-5 h-5" viewBox="0 0 14 14" role="img" focusable="false" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"><path d="M 12.4,1 1.6,1 C 1.2678571,1 1,1.26786 1,1.6 L 1,12.4 C 1,12.73214 1.2678571,13 1.6,13 l 10.8,0 C 12.732143,13 13,12.73214 13,12.4 L 13,1.6 C 13,1.26786 12.732143,1 12.4,1 m -6.9991071,8.66518 -1.0660715,0 0,-5.33036 1.0660715,0 0,5.33036 z m 4.2669642,0 -3.2008928,0 0,-1.06607 3.2008928,0 0,1.06607 z m 0,-2.13214 -3.2008928,0 0,-1.06608 3.2008928,0 0,1.06608 z m 0,-2.13483 -3.2008928,0 0,-1.06607 3.2008928,0 0,1.06607 z"></path></g></svg>
                </div>
              </div>
            </a>
          </div>
